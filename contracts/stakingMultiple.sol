    ...
    Pausable
{
     ...
     * @param _token address of the token staked by the user
    ...
    /**
     * @dev Sets external wallet address to transfer tokens
     * @param _wallet Wallet address to transfer funds after staking
     */
     ...
     * @param _tokenAddress array of addresses of tokens which can be staked
        ...
        nonReentrant
    {
        ...
        _balances[_tokenAddress][msg.sender] -= amount;
        emit Withdrawn(msg.sender, _tokenAddress, amount);
    }

    /**
     * @dev User can call this function to receive earned rewards
     * @param _tokenAddress address of tokens which were staked by user
     */
     ...
     * @param _token address of tokens which were staked by user
     */
     ...
     * @param _token address of token staked by user
     * @param account address of user
     * @return _balances Total amount of tokens staked by the user
     */
    function balanceOf(address _token, address account)
        external
        view
        override
        returns (uint256)
     ...
     * @param _token address of the tokens staked
     * @param account address of the user
     * @return rewardPerTokenStored rewards per token to be received
     */
    function earned(address _token, address account)
        public
        view
        override
        returns (uint256)
    ...
    /**
     * @dev checks if the token address is whitelisted
     * @param _token address of the token to be checked
     * @return bool if the token address is whitelisted or not to be staked
     */
